                            ...
                            <Nav navbar>
                                ...
                                <NavItem>
                                    <NavLink className="nav-link" to="/contactus"> 
                                        <span className="fa fa-vcard fa-lg"></span> Contact Us 
                                    </NavLink>    
                                </NavItem> 
                            </Nav>
                        ...
                        <Form onSubmit={this.handleLogin}>
                            <FormGroup>
                                <Label htmlFor="username">Username</Label>
                                 <Input type="text" id="username" name="username" innerRef={(input)=>this.username=input}/* innerRef... saugome reiksmes, kad galetume atvaizduoti handleLogin'e()*//>
                            </FormGroup>
                            <FormGroup>
